...
/// Dedicated detail page for approval tasks (مهام الاعتماد).
/// Shows the task-action form first, then the normal request details.
class QualityApprovalTaskDetailScreen extends StatelessWidget {
  const QualityApprovalTaskDetailScreen({
    super.key,
  ...
  static Route<void> route(String requestId) {
    return MaterialPageRoute<void>(
      builder: (_) => QualityApprovalTaskDetailScreen(requestId: requestId),
    );
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _QualityApprovalTaskDetailView(requestId: requestId),
    );
  }
}

class _QualityApprovalTaskDetailView extends StatelessWidget {
  const _QualityApprovalTaskDetailView({required this.requestId});
